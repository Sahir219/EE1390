...
for j in range(1,2000):
    ...
    y0[j]=data
y = np.empty([2000,5])
for i in range (1,2000):                      # manually assigning labels
    y[i][0]=1.1
    y[i][1]=0.0
    y[i][2]=0.0
    y[i][3]=0.0
...
for j in range(1,2000):                       # reading all the forward.wav files, coverting to mfcc format, adding labels and storing in an array
    b = "forward"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
...
for j in range(1,2000):                        # reading all the left.wav files, coverting to mfcc format, adding labels and storing in an array  
    b = "left"+str(j)+".wav"
    #print b
    data, samplerate = sf.read(b)
    data1 = mfcc(data,samplerate)
